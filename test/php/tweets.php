...
if ( !$tweet_found )
	echo $tweets = "<li>Oops, our Twitter feed is unavailable at the moment - <a href='http://twitter.com/$your_twitter_username/' target='_blank'>Follow us on Twitter!</a></li>";
